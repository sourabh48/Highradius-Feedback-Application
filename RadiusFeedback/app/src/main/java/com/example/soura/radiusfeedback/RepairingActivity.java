...
public class RepairingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFeedbackDatabase = FirebaseDatabase.getInstance().getReference().child("Feedback").child("Repairing");
            ...
            protected void onBindViewHolder(TaskViewHolder taskViewHolder, int position, ProjectData model) {
                ...
                taskViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent profileIntent = new Intent(RepairingActivity.this, FeedbackDetails.class);
                        profileIntent.putExtra("taskid", taskid);
                        profileIntent.putExtra("department", "Repairing");
