...
public class ManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFeedbackDatabase = FirebaseDatabase.getInstance().getReference().child("Feedback").child("Manager");
            ...
            protected void onBindViewHolder(TaskViewHolder taskViewHolder, int position, ProjectData model) {
                ...
                taskViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent profileIntent = new Intent(ManagerActivity.this, FeedbackDetails.class);
                        profileIntent.putExtra("taskid", taskid);
                        profileIntent.putExtra("department", "Manager");
