...
public class SecurityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFeedbackDatabase = FirebaseDatabase.getInstance().getReference().child("Feedback").child("Security");
            ...
            protected void onBindViewHolder(TaskViewHolder taskViewHolder, int position, ProjectData model) {
                ...
                taskViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent profileIntent = new Intent(SecurityActivity.this, FeedbackDetails.class);
                        profileIntent.putExtra("taskid", taskid);
                        profileIntent.putExtra("department", "Security");
